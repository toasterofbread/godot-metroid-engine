...
enum Upgrade {BOMB, CHARGEBEAM, ETANK, GRAVITY, HIGHJUMP, ICEBEAM, MISSILE, MORPHBALL, PLASMABEAM, POWERBOMB, POWERGRIP, SCREWATTACK, SPACEJUMP, SPAZERBEAM, SPEEDBOOSTER, SPIDERBALL, SPRINGBALL, SUPERMISSILE, VARIA, WAVEBEAM}
